...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "order".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link Order#execute()} method to invoke the remote operation.
   *
   * @param content the {@link com.example.abdel.myapplication.backend.myApi.model.ArrayList}
   * @return the request
   */
  public Order order(com.example.abdel.myapplication.backend.myApi.model.ArrayList content) throws java.io.IOException {
    Order result = new Order(content);
    initialize(result);
    return result;
  }

  public class Order extends MyApiRequest<com.example.abdel.myapplication.backend.myApi.model.Bean> {
     ...
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link Order#execute()} method to invoke the remote operation. <p> {@link
     * Order#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)} must
     * be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param content the {@link com.example.abdel.myapplication.backend.myApi.model.ArrayList}
     * @since 1.13
     */
    protected Order(com.example.abdel.myapplication.backend.myApi.model.ArrayList content) {
      super(MyApi.this, "POST", REST_PATH, content, com.example.abdel.myapplication.backend.myApi.model.Bean.class);
    }

    @Override
    public Order setAlt(java.lang.String alt) {
      return (Order) super.setAlt(alt);
    }

    @Override
    public Order setFields(java.lang.String fields) {
      return (Order) super.setFields(fields);
    }

    @Override
    public Order setKey(java.lang.String key) {
      return (Order) super.setKey(key);
    }

    @Override
    public Order setOauthToken(java.lang.String oauthToken) {
      return (Order) super.setOauthToken(oauthToken);
    }

    @Override
    public Order setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (Order) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public Order setQuotaUser(java.lang.String quotaUser) {
      return (Order) super.setQuotaUser(quotaUser);
    }

    @Override
    public Order setUserIp(java.lang.String userIp) {
      return (Order) super.setUserIp(userIp);
    }

    @Override
    public Order set(String parameterName, Object value) {
      return (Order) super.set(parameterName, value);
    }
  }
